...
public class DefaultServletRequestFilterTest {
    ...
    public void defaultName() throws ServletException {
        ...
        Mockito.when(config.getServletContext().getNamedDispatcher(DefaultServletRequestFilter.DEFAULT_SERVLET_NAME))
    ...
    public void servletNameFromInitParam() throws ServletException {
        ...
        Mockito.when(config.getInitParameter(DefaultServletRequestFilter.SERVLET_PARAMETER_NAME))
                .thenReturn(servletName);
